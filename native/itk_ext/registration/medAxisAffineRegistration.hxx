/*=========================================================================
  ...
  medAxisAffineRegistration.hxx

=========================================================================*/
#ifndef medAxisAffineRegistration_hxx
#define medAxisAffineRegistration_hxx

#include "medAxisAffineRegistration.h"
...
AffineRegistration<TFixedImage, TMovingImage>::AffineRegistration()
{
...
AffineRegistration<TFixedImage, TMovingImage>::MakeOutput(DataObjectPointerArraySizeType)
{
...
template <typename TFixedImage, typename TMovingImage>
void
AffineRegistration<TFixedImage, TMovingImage>::SetFixedImage(const TFixedImage* image)
{
...
template <typename TFixedImage, typename TMovingImage>
const TFixedImage*
AffineRegistration<TFixedImage, TMovingImage>::GetFixedImage() const
{
...
template <typename TFixedImage, typename TMovingImage>
void
AffineRegistration<TFixedImage, TMovingImage>::SetMovingImage(const TMovingImage* image)
{
...
template <typename TFixedImage, typename TMovingImage>
const TMovingImage*
AffineRegistration<TFixedImage, TMovingImage>::GetMovingImage() const
{
    return static_cast<const TMovingImage*>(this->ProcessObject::GetInput(1));
}

template <typename TFixedImage, typename TMovingImage>
typename AffineRegistration<TFixedImage, TMovingImage>::OutputImageType*
AffineRegistration<TFixedImage, TMovingImage>::GetOutput()
{
...
template <typename TFixedImage, typename TMovingImage>
void
AffineRegistration<TFixedImage, TMovingImage>::GenerateData()
{
    ...
    initializer->SetOperationMode(InitializerType::GEOMETRY);
...
#endif // medAxisAffineRegistration_hxx
